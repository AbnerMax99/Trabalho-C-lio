...
def relatcursoesp():
    ...
    try:  # Tratamento de erro
        ...
        for i in range(len(disciplinas)):   #(ABNER) Aqui eu queria mostrar todas as disciplinas inseridas
            print(f'{disciplinas[select_curso]}')   #Ele mostra apenas a ultima a inserida
        lin()
    except:
...
def altd():
    ...
    select_d = str(input('Selecione a disciplina que deseja alterar: ')).upper() #Nao esta encontrando a disciplina ERRO
